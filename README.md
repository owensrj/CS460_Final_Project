...
- `eia_client.py`  
  Connects to the EIA API and converts the API results to usable data fields.
...
Python standard library modules only. Written using Python 3.
...
Then I added the key exactly in this format, with no spaces:
